...
public class Render extends JFXPanel {
    ...
    public void paint(Graphics g) {
        ...
        BufferedImage ship = (BufferedImage) Util.getImage("spaceship/default.png"); 
        ship = ship.getSubimage(Main.shipFrame, 0, 100, 136);
        gfx.drawImage(ship, Spaceship.position, Main.HEIGHT - Spaceship.y, null);
        
        for(int b : GameHandler.bullets.keySet()) {
        	HashMap<String, Object> bullet = GameHandler.bullets.get(b);
        	gfx.setColor(Color.RED);
        	gfx.fillRect((int) bullet.get("position"), (int) bullet.get("y"), 3, 7);
        }
    }
}
